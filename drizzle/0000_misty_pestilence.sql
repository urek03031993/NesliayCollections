...
CREATE TYPE "public"."product_category" AS ENUM('mommy_and_me', 'boys', 'girls');--> statement-breakpoint
CREATE TYPE "public"."rental_status" AS ENUM('draft', 'prebook', 'reserved', 'cancelled');--> statement-breakpoint
...
CREATE TABLE "client" (
	...
	"phone" varchar(20),
	"document_type" varchar(20) DEFAULT 'license',
	...
	CONSTRAINT "client_identification_document_unique" UNIQUE("identification_document")
);
...
CREATE TABLE "product" (
	...
	"category" "product_category" DEFAULT 'mommy_and_me' NOT NULL,
...
ALTER TABLE "rental" ADD CONSTRAINT "rental_clientId_client_id_fk" FOREIGN KEY ("clientId") REFERENCES "public"."client"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
